...
def draw_graph(P: dict, N: dict, I: dict, none: dict):
    ...
    my_page_warning_ax.plot(P["date"], P["data"], label="Positive Value")
    my_page_warning_ax.plot(N["date"], N["data"], label="Negative Value")
    my_page_warning_ax.plot(I["date"], I["data"], label="Intensity Value")
    my_page_warning_ax.plot(none["date"], none["data"], label="Tiny Attitude Value")
